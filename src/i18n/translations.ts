...
export const translations = {
  en: {
    ...
    'contact.whereHeading': 'Where we are',
    'contact.emailHeading': 'Email',
    'contact.phoneHeading': 'Phone',
    'contact.socialHeading': 'Find us online',
  ...
  ne: {
    ...
    'nav.home': 'गृहपृष्ठ',
    'nav.about': 'परिचय',
    'nav.notices': 'सूचना तथा समाचार',
    'nav.faculty': 'शिक्षक तथा कर्मचारी',
    'nav.contact': 'सम्पर्क',
    ...
    'contact.messageLabel': 'तपाईंको सन्देश *',
    'contact.sendBtn': 'सन्देश पठाउनुहोस्',
    'contact.whereHeading': 'हाम्रो ठेगाना',
    'contact.emailHeading': 'इमेल',
    'contact.phoneHeading': 'फोन नम्बर',
    'contact.socialHeading': 'सामाजिक सञ्जालमा जोडिनुहोस्',
...
/**
 * Client-side script string that initializes language state from localStorage
 * and updates all [data-i18n] and [data-i18n-html] elements dynamically on language switch.
 */
...
(function() {
  ...
  function updatePageText(lang) {
    ...
    document.querySelectorAll('[data-lang-toggle]').forEach(btn => {
      const textEl = btn.querySelector('.lang-text') || btn;
      textEl.textContent = lang === 'en' ? 'नेपाली' : 'English';
      btn.setAttribute('aria-label', lang === 'en' ? 'Switch to Nepali' : 'Switch to English');
    });
  ...
  // Run on initial DOM ready and Astro view transitions
  document.addEventListener('DOMContentLoaded', applyLang);
  document.addEventListener('astro:page-load', applyLang);
